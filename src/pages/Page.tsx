      ...
      <section className={styles.solutionSection}>
        <div className={styles.solution}>
          <div className={styles.sectionHeader}>
            <div className={styles.sectionHeaderText1}>OUR Solution</div>
          </div>
        ...
        <div className={styles.section2}>
          ...
          <section className={styles.pilots}>
            <div className={styles.pilot1}>
              <div className={styles.headline7}>Hyderabad, india 🇮🇳</div>
          ...
          <section className={styles.pilots}>
            ...
            <div className={styles.pilot1}>
              <div className={styles.headline7}>Tokyo, Japan 🇯🇵</div>
